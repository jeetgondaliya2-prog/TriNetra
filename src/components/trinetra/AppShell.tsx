...
const NAV = [
  ...
  { to: "/camera-vision", label: "Camera Vision", icon: Camera, desc: "Live CV feed" },
  { to: "/e-challan", label: "E-Challan", icon: FileText, desc: "Violation fines" },
  { to: "/dispatch", label: "Police Dispatch", icon: Siren, desc: "Emergency response" },
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-background" data-weather={world.weather}>
      ...
      <aside className="sticky top-0 z-10 hidden h-screen w-[248px] shrink-0 flex-col border-r border-border bg-surface/90 backdrop-blur lg:flex">
